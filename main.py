...
SKILLS = [
    ...
    "scikit-learn", "git", "github", "aws", "azure", "docker",
    "kubernetes", "node.js", "express", "typescript", "linux",
    "cybersecurity", "networking", "ci/cd", "graphql",
    "rest api", "api development", "oop",
    "object oriented programming", "data structures",
    "algorithms", "problem solving", "mysql",
    "postgresql", "agile", "scrum",
    "unit testing", "pytest", "jenkins",
...
def index():
    ...
    if request.method == "POST":
        ...
        # -------------------------
        resume_skills = list(set(extract_skills(resume)))
        ...
        if len(missing_skills) == 0 and len(job_skills) > 0:
            final_score = 100
        else:
